...
const CustomPrevArrow = ({ onClick }) => (
    <button
        onClick={onClick}
        className="w-[40px] h-[40px] sm:w-[60px] sm:h-[60px] flex items-center text-[#F15A2B] justify-center absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-[#C7C7C7] p-3 rounded-full hover:border-2 hover:border-[#F15A2B]"
    >
...
const CustomNextArrow = ({ onClick }) => (
    <button
        onClick={onClick}
        className="w-[40px] h-[40px] sm:w-[60px] sm:h-[60px] flex items-center text-[#F15A2B] justify-center absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-[#C7C7C7] p-3 rounded-full hover:border-2 hover:border-[#F15A2B]"
    >
