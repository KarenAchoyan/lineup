        ...
        <div className="bg-[#211d1dfc] photo-background h-screen py-[180px]">
            <div className='flex items-center justify-center'>
                <div className="container bg-[#4d4c4c2b] min-h-[70vh] pt-[50px] rounded-lg shadow-xl p-8">
                    <h1 className='text-[30px] md:text-[40px] text-[#C7C7C7] text-center'>Photo/video</h1>
                    <h3 className='text-[20px] md:text-[24px] text-[#C7C7C7] text-center'>Professional photography and videography</h3>
